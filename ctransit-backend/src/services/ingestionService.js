...
const { parseTransactionBatch, buildDeltaCommand } = require('../utils/parser');
const { deductFare, isBelowThreshold } = require('./ledgerService');
const { broadcastDeltaToFleet } = require('./syncService');
...
module.exports = { ingestTransactionBatch };
