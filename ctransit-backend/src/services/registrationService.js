...
const { getRedisClient, redisKeys, OTP_TTL_SECONDS } = require('../config/redis');
const { activateWallet } = require('./ledgerService');
const { buildDeltaCommand } = require('../utils/parser');
const { routeDeltaToTerminal, broadcastDeltaToFleet } = require('./syncService');
const { prisma } = require('./ledgerService');
...
module.exports = { handlePendingLink, confirmRegistration };
